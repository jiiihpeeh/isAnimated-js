...
Minified sizes (generated by `node scripts/sizes.mjs`, requires `esbuild`):

| Entry point | Raw | Gzipped | Brotli |
|---|---|---|---|
| Full library (`is-animated`) | 4.5 KB | 1.7 KB | 1.5 KB |
| `is-animated/gif` | 558 B | 318 B | 303 B |
| `is-animated/png` | 363 B | 281 B | 258 B |
| `is-animated/webp` | 456 B | 308 B | 273 B |
| `is-animated/avif` | 300 B | 236 B | 214 B |
| `is-animated/jxl` | 2.0 KB | 938 B | 871 B |
